    ...
    TictactoeComponent.prototype.updateField = function (id, value) {
        ...
        this.service.updateField(this.createUrl(this.config.updateField, id), field).subscribe(function (res) {
            ...
            if (gameStatus.getId() === TictactoeComponent_1.ID_GAME_IN_PROGRESS) {
                _this.setNewField(res.getField());
            }
            _this.status = gameStatus.getText();
...
var TicTacToeService = /** @class */ (function () {
    ...
    TicTacToeService.prototype.handleError = function (error) {
        return new __WEBPACK_IMPORTED_MODULE_4_rxjs_observable_ErrorObservable__["a" /* ErrorObservable */](TicTacToeService_1.ERROR_MESSAGE);
    };
