...
var DashboardComponent = /** @class */ (function () {
    ...
    DashboardComponent.prototype.createTicTacToeInfo = function () {
        var _this = this;
        this.dashboardService.getDescriptionForSudoku().subscribe(function (description) { return _this.setDescriptionWithDelay(description); });
    };
    ...
    DashboardComponent.prototype.createSudokuInfo = function () {
        var _this = this;
        this.dashboardService.getDescriptionForTicTacToe().subscribe(function (description) { return _this.setDescriptionWithDelay(description); });
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__url_constants_AppUrlValuesInjectionToken__ = __webpack_require__("../../../../../src/app/url-constants/AppUrlValuesInjectionToken.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_common_http__ = __webpack_require__("../../../common/esm5/http.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_rxjs_add_operator_map__ = __webpack_require__("../../../../rxjs/_esm5/add/operator/map.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__description__ = __webpack_require__("../../../../../src/app/dashboard/description.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var DashboardService = /** @class */ (function () {
    function DashboardService(config, httpClient) {
        this.config = config;
        this.httpClient = httpClient;
    }
    DashboardService.prototype.getDescriptionForSudoku = function () {
        return this.fetchDescription(this.config.descriptionSudoku);
    };
    DashboardService.prototype.getDescriptionForTicTacToe = function () {
    ...
    DashboardService.prototype.fetchDescription = function (url) {
        ...
        return this.httpClient.get(url).
            map(function (res) { return new __WEBPACK_IMPORTED_MODULE_4__description__["a" /* Description */](res['name'], res['numberOfPlayers']); }).
    ...
    DashboardService = __decorate([
        ...
        __param(0, Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["z" /* Inject */])(__WEBPACK_IMPORTED_MODULE_1__url_constants_AppUrlValuesInjectionToken__["a" /* AppUrlValuesInjectionToken */])),
...
var TictactoeComponent = /** @class */ (function () {
    function TictactoeComponent(router, config) {
        this.router = router;
        this.config = config;
    }
